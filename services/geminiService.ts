...
export const analyzePlantImage = async (imageBuffer: string) => {
  ...
  PROTEÇÃO DE FRAUDE: NUNCA retorne a mensagem "O segredo da mata exige clareza" ou similares. Se houver uma folha visível, você DEVE identificá-la usando sua base de dados ancestral e botânica.
